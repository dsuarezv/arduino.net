...
namespace OxyPlot.Universal
{
    ...
    /// Implements <see cref="IRenderContext" /> for <see cref="System.Windows.Controls.Canvas" />.
    /// </summary>
    public class UniversalRenderContext : IRenderContext
    {
        /// <summary>
        /// The brush cache.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UniversalRenderContext" /> class.
        /// </summary>
        /// <param name="canvas">The canvas.</param>
        public UniversalRenderContext(Canvas canvas)
        {
            this.canvas = canvas;
